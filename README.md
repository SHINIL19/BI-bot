...
- **Agentic AI**: Built with the Vercel AI SDK and Google's Gemini 2.0 Flash model. The agent is capable of autonomous tool calling to find board IDs, fetch schemas, investigate records, and perform granular searches.
